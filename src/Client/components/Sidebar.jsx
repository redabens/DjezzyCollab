  ...
  return (
    <div className="container">
      <div className="sidebar">
        ...
        <div className="options" style={{gap:navbar.admin? '3.26vh': '22vh'}}>
          <div className="optionsUp">
            {menuItemUp.map((item, index) => {
                return item.name === "Administrateur" ? (
                  ...
                  sx={{all:'unset'}}
                  className="linkSpe">
                      <Administrateur state={navbar} handleAdmin={item.func} handleGestRep={()=>{setNavBar(prev => ({
                        upload:false,
                        download:false,
                        admin:true,
                        gestRep:true,
                        ...
                        params:false,
                        aide:false,
                      }))}} handleGestUtils={()=>{setNavBar(prev => ({
                        upload:false,
                        download:false,
                        admin:true,
                        gestRep:false,
                        ...
                        params:false,
                        aide:false,
                      }))}} handleCreatCompte={()=>{setNavBar(prev =>({
                        upload:false,
                        download:false,
                        admin:true,
                        gestRep:false,
                ...
                <NavLink
                  ...
                  onClick={item.func}
                  style={{backgroundColor: item.couleur() ? "#f8cece" : 'null'}}
                >
